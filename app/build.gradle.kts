...
android {
    namespace = "org.michaelbel.palettecolors"
    compileSdk = libs.versions.compile.sdk.get().toInt()

    defaultConfig {
        applicationId = "org.michaelbel.palettecolors"
...
base {
    archivesName.set("PaletteColors-v${android.defaultConfig.versionName}(${android.defaultConfig.versionCode})")
}
